...
public class RefinedRadianceAxeItem
extends AxeItem {
    ...
    public RefinedRadianceAxeItem() {
        super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes((Tier)TOOL_TIER, (float)11.0f, (float)-2.6f)).fireResistant());
    }
}
