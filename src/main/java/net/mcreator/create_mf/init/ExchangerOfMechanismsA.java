...
public class ExchangerOfMechanismsA {
    ...
    public static void registerExchangerOfMechanismsA(VillagerTradesEvent event) {
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(2), new BasicItemListing(ExchangerOfMechanismsA.createItem("water_wheel", 1), new ItemStack((ItemLike) Items.EMERALD, 3), ExchangerOfMechanismsA.createItem("large_water_wheel", 1), 10, 5, 0.02f));
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(3), new BasicItemListing(ExchangerOfMechanismsA.createItem("depot", 1), new ItemStack((ItemLike) Items.EMERALD, 3), ExchangerOfMechanismsA.createItem("weighted_ejector", 1), 10, 7, 0.02f));
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(5), new BasicItemListing(ExchangerOfMechanismsA.createItem("chest", 1), new ItemStack((ItemLike) Items.EMERALD, 4), ExchangerOfMechanismsA.createItem("item_vault", 1), 20, 8, 0.03f));
