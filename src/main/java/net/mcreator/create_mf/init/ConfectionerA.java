...
public class ConfectionerA {
    ...
    public static void registerConfectioner(VillagerTradesEvent event) {
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(2), new BasicItemListing(ConfectionerA.createItem("cinder_flour", 29), new ItemStack((ItemLike) Items.EMERALD), 20, 5, 0.03f));
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(5), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 12), ConfectionerA.createItem("blaze_cake", 1), 8, 8, 0.06f));
