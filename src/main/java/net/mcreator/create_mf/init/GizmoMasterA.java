...
public class GizmoMasterA {
    ...
    public static void registerGizmoMasterA(VillagerTradesEvent event) {
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(2), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 6), GizmoMasterA.createItem("mechanical_piston", 1), 15, 4, 0.01f));
        CmfTradeGuard.safeAdd((List) event.getTrades().get(2), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 6), GizmoMasterA.createItem("mechanical_bearing", 1), 15, 4, 0.01f));

        CmfTradeGuard.safeAdd((List) event.getTrades().get(3), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 10), GizmoMasterA.createItem("gantry_carriage", 1), 10, 6, 0.02f));
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(4), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 8), GizmoMasterA.createItem("rope_pulley", 1), 10, 8, 0.03f));

        CmfTradeGuard.safeAdd((List) event.getTrades().get(5), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 16), GizmoMasterA.createItem("elevator_pulley", 1), 5, 9, 0.05f));
        CmfTradeGuard.safeAdd((List) event.getTrades().get(5), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 6), GizmoMasterA.createItem("radial_chassis", 2), 15, 9, 0.05f));
    }
