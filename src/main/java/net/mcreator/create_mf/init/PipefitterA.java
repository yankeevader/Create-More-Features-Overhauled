...
public class PipefitterA {
    ...
    public static void registerPipefitterA(VillagerTradesEvent event) {
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(2), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 3), PipefitterA.createItem("item_drain", 1), 16, 6, 0.05f));
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(3), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 5), PipefitterA.createItem("fluid_tank", 1), 27, 7, 0.05f));
        CmfTradeGuard.safeAdd((List) event.getTrades().get(3), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 6), PipefitterA.createItem("spout", 1), 15, 7, 0.05f));
        ...
        CmfTradeGuard.safeAdd((List) event.getTrades().get(4), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 6), PipefitterA.createItem("copper_diving_helmet", 1), 7, 10, 0.05f));
        CmfTradeGuard.safeAdd((List) event.getTrades().get(4), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 4), PipefitterA.createItem("copper_diving_boots", 1), 7, 10, 0.05f));

        CmfTradeGuard.safeAdd((List) event.getTrades().get(5), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 12), PipefitterA.createItem("steam_engine", 1), 15, 7, 0.05f));
        CmfTradeGuard.safeAdd((List) event.getTrades().get(5), new BasicItemListing(new ItemStack((ItemLike) Items.EMERALD, 6), PipefitterA.createItem("smart_fluid_pipe", 1), 18, 7, 0.05f));
    }
